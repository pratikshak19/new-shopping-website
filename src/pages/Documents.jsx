const FILES = [
  ['Vercel upload (ZIP)', '/docs/Trendora_For_Vercel.zip', 'Trendora_For_Vercel.zip', 'Unzip on laptop, then npx vercel --prod on the existing project.'],
  ...
  return (
    <div className="wrap" style={{ paddingBottom: 72 }}>
      <div className="page-hero">
        ...
        <p className="muted">
          College papers for this same Trendora site. Pink button saves the file.
          How to use: <a href="/help">Help</a>. If the preview blocks download, open <a href="/download.html">/download.html</a>.
        </p>
      </div>
